...
export default function HeroDesktop({
  ...
  return (
    <div className="overflow-hidden bg-blue">
      ...
      <div
        className={`relative flex ${seenHero ? `h-screen` : `h-[150vh]`} items-center justify-center`}
      >
        ...
        <div
          className={`secondaryImage-0-arm absolute left-[23vw] ${seenHero ? `top-[10vh]` : `top-[42vw]`} h-[0.1rem] w-[21vw]`}
        >
          {secondaryImages[0] && (
            <Image
        ...
        <div
          className={`secondaryImage-1-arm absolute left-[77vw] ${seenHero ? `top-[22vh]` : `top-[calc(15vh+31vw)]`} h-[0.1rem] w-[21vw]`}
        >
          {secondaryImages[1] && (
            <Image
        ...
        <div
          className={`secondaryImage-2-arm absolute left-[27vw] ${seenHero ? `top-[75vh]` : `top-[calc(70vh+21vw)]`} h-[0.1rem] w-[21vw]`}
        >
          {secondaryImages[2] && (
            <Image
        ...
        <div
          className={`secondaryImage-3-arm absolute left-[60vw] ${seenHero ? `top-[102vh]` : `top-[calc(100vh+10vw)]`} h-[0.1rem] w-[21vw]`}
        >
          {secondaryImages[3] && (
            <Image
        ...
        <div
          className={`secondaryImage-4-arm absolute left-[90vw] ${seenHero ? `top-[40vh]` : `top-[calc(35vh+21vw)]`} h-[0.1rem] w-[21vw]`}
        >
          {secondaryImages[4] && (
            <Image
        ...
        <div
          className={`secondaryImage-5-arm absolute left-[15vw] ${seenHero ? `top-[55vh]` : `top-[calc(50vh+21vw)]`} h-[0.1rem] w-[21vw]`}
        >
          {secondaryImages[5] && (
            <Image
