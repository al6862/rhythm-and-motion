...
// Query: {    'community': *[_type == 'community'][0] {    _id,    _type,    title,    header,    image {    caption,    'assetId': asset->_id,    'assetPath': asset->path,    'aspectRatio': asset->metadata.dimensions.aspectRatio,},    events[] -> {    _id,    _type,    title,    slug,    location,    address {        ...,          _type == "link" => {    ...,    internalLink->{_type,slug,title}  },    },    startDate,    endDate,    image {    caption,    'assetId': asset->_id,    'assetPath': asset->path,    'aspectRatio': asset->metadata.dimensions.aspectRatio,},    content[] {        ...,          _type == "link" => {    ...,    internalLink->{_type,slug,title}  },    },},},}
