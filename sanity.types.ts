...
// Query: {    'community': *[_type == 'community'][0] {    _id,    _type,    title,    events[] {    _id,    _type,    title,    eventLink {        ...,          _type == "link" => {    ...,    internalLink->{_type,slug,title}  },    },    content[] {        ...,          _type == "link" => {    ...,    internalLink->{_type,slug,title}  },    },},},}
