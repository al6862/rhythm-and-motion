...
export default function Teachers({ content }: TeachersProps) {
  ...
  return (
    <div className="flex w-screen flex-col md:relative md:flex-row">
      <div className="hidden w-screen md:block md:h-screen">
        <div className="md:relative md:size-full">
          {image?.assetPath ? (
            ...
            <div
              className="size-fullcursor-pointer absolute inset-0"
      ...
      <div
        className={`z-5 no-scrollbar md:r-0 relative overflow-y-scroll transition-all after:bg-white md:h-screen md:w-1/3 md:min-w-[493px] md:py-[100px] md:pb-[16px] md:pl-[16px] md:pr-[30px]`}
        style={{
